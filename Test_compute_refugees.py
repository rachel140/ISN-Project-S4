...
def estimate_other_climatic_refugees(year):
    ...
    drought = round(climate_features.get('drought_index', 0) + 0.01 * years_passed, 2)  # increase drought index
    flood = round(climate_features.get('flood_risk', 0) + 0.015 * years_passed, 2)      # increase flood risk
