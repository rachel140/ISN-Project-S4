...
class Controller:
    ...
    def set_views(self, mainview, secondaryview):
        ...
        self.chosen_year = self.main_view.get_user_year()
        self.sea_level_value = self.sea_level.retrieve_sea_level(self.chosen_year,
                                                                 self.main_view.get_ipcc_value()
                                                                 )

        #refugee information:
        reference_elevation = 0.21
        self.nb_refugees = self.elevation_data.compute_refugees(self.chosen_year,
    ...
    def get_where_clicked(self):
        ...
        #print(f"corresponds to:{lat} and {lon}")
        return (lat, lon)
